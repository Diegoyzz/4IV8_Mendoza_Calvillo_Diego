...
app.get('/api', (req, res) => {
    res.json({
        ...
        endpoint : {
            ...
            //  Agregado a la documentación visual de tu API
            videos : {
                listar : 'GET /api/videos',
                obtener : 'GET /api/videos/:id',
                crear : 'POST /api/videos',
                actualizar : 'PUT /api/videos/:id',
                eliminar : 'DELETE /api/videos/:id'
            }
        }
    });
});
